        ...
        for student in self.student_list:
            ...
            for course in student.course_offered:
                if course.elective_type == "TE" and student.transcript_before.completed_credit < 155:
                    student.errors.append("The advisor didnt approve TE - " + course.course_name + " because student completed credits less than 155")
                    ...
                    student.errors.append("The advisor didnt approve " + course.course_name + " because student completed credits less than 165")
